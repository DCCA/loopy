# Model-Upgrade Migration Loop Specification

> Source of truth. Established by change `add-model-upgrade-migration` (2026-06-23).
> A long-horizon loop on `runPlan` + `Gate` + `StateStore`.
