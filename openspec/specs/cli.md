# loopy CLI Specification

> Source of truth. Established by change `add-loopy-cli` (2026-06-21).

The `loopy` CLI delivers the product's **1-click loop import** differentiator.
