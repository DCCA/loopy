# Codemod-Campaign Loop Specification

> Source of truth. Established by change `add-codemod-campaign` (2026-06-23).
> A cross-PR campaign on the long-horizon primitives (StateStore ledger + Gate).
